...
namespace MyGameSystem
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ICustomerService customerManager = new CustomerManager(new List<ILoggerService> { databaseLogger, fileLogger }, new
                List<IPersonVerificationService> { personVerificationService } );
